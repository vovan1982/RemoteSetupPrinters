...
namespace RemoteSetupPrinters.ProgressDialog
{
    /// <summary>
    /// Логика взаимодействия для ProgressDialog.xaml
    /// </summary>
    public partial class ProgressDialog : Window, IDisposable
    {
        ...
        void OnCancelButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                SubLabel = "Пожалуйста подождите, идёт завершение процесса...";
